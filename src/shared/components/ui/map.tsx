// biome-ignore-all lint: This file is a bit long but it's all in one place for ease of maintenance and to avoid unnecessary re-renders from context changes. We can split it up if it grows too much, but for now it's manageable.
